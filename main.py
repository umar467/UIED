...
def parse_args():
    ...
    parser.add_argument("--input_video", type=str, default='data/input/videos/demo1.mp4', required=False, help="File path for the input mp4 file. Best to give an absolute path like /usr/bin/../../file.mp4")
